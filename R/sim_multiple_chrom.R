...
#' @examples
#' \dontrun{
#' sim_multiple_chrom(pop_size = 100, freq_ancestor_1 = 0.5,
#'                     total_runtime = 10, size_in_morgan = 1,
#'                     markers = 10, time_points = c(0, 5, 10),
#'                     num_threads = 1)
#' }
#' @export
sim_multiple_chrom <- function(pop_size = 100,
                               freq_ancestor_1 = 0.5,
                               total_runtime = 100,
                               size_in_morgan = c(1, 1),
                               markers = 100,
                               time_points = -1,
                               num_threads = 1,
                               verbose = FALSE,
  ...
  markers <- get_num_markers_chrom(markers, size_in_morgan)

  output <- sim_phased_unphased_multi_cpp(pop_size,
                                          freq_ancestor_1,
                                          total_runtime,
                                          size_in_morgan,
                                          markers,
