...
```{r, repl_sim_inf}
  ...
  for(r in 1:number_replicates) {
    v2 <- sim_inf_chrom(N, H_0, maxT, C, numMarkers, r)  
...
```
We see that the simulations do not exactly match our prediction, but this can easily be improved by increasing the number of replicates.
